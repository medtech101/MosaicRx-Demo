...
[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/medtech101/medical-study-agent)
...
using the blueprint at the repo root (`render.yaml`). Every secret it prompts
for is optional. You'll get a live `https://medical-study-agent-*.onrender.com`
URL you can open on any tablet or phone.
...
```bash
git clone https://github.com/medtech101/medical-study-agent.git
cd medical-study-agent
./run.sh
```
...
```bash
cd medical-study-agent
docker build -t medical-study-agent .
